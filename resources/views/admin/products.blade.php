        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a class="nav-link" href="offers.html"><i class="far fa-square"></i> <span>Offers</span></a>
                    </li>
                ...
                <div class="section-body">
                    ...
                    <div class="row product-lists">
                        <div class="col-lg-4 col-md-6 text-center strawberry">
                            <div class="single-product-item">
                                <div class="product-image">
                                    <a href="single-product.html"><img id="product-image"
                                            src="assets/img/img/seeds/seeds1.jpg" alt=""></a>
                                </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="text" id="new-price" class="form-control"
                                            placeholder="Enter new price">
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-primary"
                                            onclick="handleUpdateClick()">Confirm Update</button>
                        ...
                        <div class="col-lg-4 col-md-6 text-center berry">
                            <div class="single-product-item">
                                <div class="product-image">
                                    <a href="single-product.html"><img src="assets/img/img/tools/tool2.jpg"
                                            alt="" height="30%"></a>
                                </div>
                                <h3>tool2</h3>
                                <p class="product-price"><span>Per Kg</span> 70$ </p>
                                <a href="#" class="cart-btn"> Update</a> <a href="#" class="cart-btn">
                                    delete </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 text-center">
                            <div class="single-product-item">
                                <div class="product-image">
                                    <a href="single-product.html"><img src="assets/img/img/tools/tool3.jpg"
                                            alt=""></a>
                                </div>
                                <h3>tool3</h3>
                        ...
                        <div class="col-lg-4 col-md-6 text-center strawberry">
                            <div class="single-product-item">
                                <div class="product-image">
                                    <a href="single-product.html"><img src="assets/img/img/seeds/seeds12.jpg"
                                            alt=""></a>
                                </div>
                                <h3>seed</h3>
                        ...
                        <div class="col-lg-4 col-md-6 text-center berry">
                            <div class="single-product-item">
                                ...
                                <h3>tool2</h3>
                                <p class="product-price"><span>Per Kg</span> 70$ </p>
                                <a href="#" class="cart-btn update"
                                    onclick="handleUpdateButtonClick(event, 1)">Update</a>
                                <a href="#" class="cart-btn delete"
                                    onclick="handleDeleteButtonClick(event, 1)">Delete</a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 text-center lemon">
                            <div class="single-product-item">
